...
# Derived, not remembered: the share of the companion certification panel that is
# nonroad, which bounds what this paper can say about that panel.
...
That panel is {NONROAD_PCT} nonroad, and this analysis covers transportation-sector
...
companion certification panel is **{NONROAD_PCT} nonroad** ({NONROAD_N} certified families).
